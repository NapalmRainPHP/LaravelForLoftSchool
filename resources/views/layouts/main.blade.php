				...
				<div class="sidebar-item__content">
					<ul class="sidebar-category">
						@foreach($Categories AS $category)
							<li class="sidebar-category__item" hint="{{$category->Description}}"><a href="{{url('/search/category/'.$category->Title)}}" class="sidebar-category__item__link">{{$category->Title}}</a></li>
						@endforeach
					</ul>
				</div>
			</div>
